...
TENTACLES_INVENTORY = (
    ...
    .add_testbed_instance(
        ...
        tentacles=[
            ...
            ("de646cc20b92-5425", "v1.1", tentacle_specs.RPI_PICO),  # v0.4
            ("e46340474b17-4429", "v1.0", tentacle_specs.PYBV11),
            # testbed micropython
    ...
    .add_testbed_instance(
        ...
        tentacles=[
            ...
            ("e46414481355-442b", "v0.0", tentacle_specs.ESP32_C3_DEVKIT),
            ("e46414481348-1930", "v1.0", tentacle_specs.ESP32_S3_DEVKIT),
            ...
            ("e46414481349-1521", "v0.0", tentacle_specs.AA_UNASSEMBLED),
