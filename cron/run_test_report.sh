...
mptest test --testresults=$DIRECTORY_REPO/testresults --micropython-tests="$REPO" --firmware-build="$REPO" --no-multiprocessing --count=2 --skip-fut=FUT_WLAN --skip-fut=FUT_BLE 
